...
export type LikePostResultResolvers<ContextType = RequestContext, ParentType extends ResolversParentTypes['LikePostResult'] = ResolversParentTypes['LikePostResult']> = {
